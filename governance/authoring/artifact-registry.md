...
| `docs.neutrality-governance-spec` | `../../docs/remediation/neutrality-governance-spec.md` | human documentation / execution spec | `../../MANIFEST.md` | active | none | 2026-05-24 | `../composition/context-composition.md`, `../../INDEX.md`, `../../README.md`, `../../rules/quality/README.md`, `../../prompts/hooks/README.md`, `../../evals/manual-regression-suite.md`, `../../docs/remediation/README.md` |
| `docs.hygiene-governance-spec` | `../../docs/remediation/hygiene-governance-spec.md` | human documentation / execution spec | `../../MANIFEST.md` | active | none | 2026-05-24 | `../composition/context-composition.md`, `../../INDEX.md`, `../../README.md`, `../quality/README.md`, `../../prompts/hooks/README.md`, `../../evals/manual-regression-suite.md`, `../../docs/remediation/README.md` |
